<template>
  <div>
    ...
    <el-table :data="currentPageData" v-loading="loading" style="width: 100%" border stripe>
      ...
      <el-table-column label="操作" width="160">
        <template #default="{ row }">
          <el-button size="small" type="warning" @click="editEquipment(row)" :loading="loading">
            修改
          </el-button>
          <el-button size="small" type="danger" @click="deleteEquipment(row.equipmentId)" :loading="loading">
            删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <!-- 新增设备弹框 -->
    <el-dialog :visible.sync="addDialogVisible" title="新增设备" @close="resetAddForm">
